...
Original file is located at
    https://colab.research.google.com/drive/11RpkMioKh6_XzFDFY3zMdPGTMXYT2Icn
"""
...
def create_model(learning_rate, num_lstm_units, num_batch_size, num_epochs):
    ...
    model.add(GRU(units=num_lstm_units, input_shape=(x_train.shape[1], x_train.shape[2])))
...
plt.plot(inv_yhat, label='predictions', color= 'green')
